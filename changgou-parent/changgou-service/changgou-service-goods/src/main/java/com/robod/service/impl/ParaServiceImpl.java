...
import com.robod.mapper.ParaMapper;
import com.robod.service.intf.ParaService;
...
public class ParaServiceImpl implements ParaService {
    ...
    public List<Para> findParaByCategoryId(Integer id) {
        //1.根据分类的ID 获取到模板的ID
        int templateId = categoryMapper.findById(id).getTemplateId();
        //2.根据模板的ID 获取参数的列表 返回
        return paraMapper.findByTemplateId(templateId);
    }
}
